...
@ValidatorConstraint()
export class GreaterThanOrEqualToValidatorConstraint implements ValidatorConstraintInterface {
  ...
  public defaultMessage(validationArguments: ValidationArguments): string {
    return `${validationArguments.property} must be greater than or equal to: ${validationArguments.constraints[0]}`;
  }
}
